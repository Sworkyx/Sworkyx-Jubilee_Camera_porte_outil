...
OCTOPI_IP = "10.0.9.55"  # ex: "192.168.X.X"
...
class Detection_lentille:
    ...
    def capture_octopi_image(
        ...
        output_file = f"lens_picture.jpg" # ex: "lens_picture.jpg"
    ...
    def detect_lens():
        ...
        kernel = np.ones((7, 7), np.uint8)  # ex: (7, 7)
        ...
        for cnt in contours:
            ...
            if area > 10:  # ex: 10 à adapter selon résolution
                lens_found = True
                valid_lenses += 1
